-- Add coordinates column to farms table for satellite imagery integration using geometry type
ALTER TABLE farms ADD COLUMN IF NOT EXISTS coordinates GEOMETRY(POINT, 4326);
