...
export default function TodaysFarmPlan() {
      ...
      setTimeout(() => {
        const newTask: Task = {
          ...
          weather: {
            ...
            recommendation:
              'Apply organic pesticide immediately to prevent spread',
          },
          aiImportance: 10,
        ...
        toast.warning('New Urgent Farm Task', {
          description:
            'AI has detected a pest outbreak requiring immediate attention.',
          action: {
            label: 'View',
  ...
  const getWeatherIcon = (recommendation: string) => {
    if (recommendation.includes('rain'))
      return <CloudRain className="h-4 w-4 text-blue-500" />;
    if (recommendation.includes('dry'))
      return <Sun className="h-4 w-4 text-amber-500" />;
    if (recommendation.includes('humidity'))
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center mb-2">
              ...
              <div
                className={`text-xl font-bold ${getFarmScoreColor()} flex items-center gap-1`}
              >
                {farmScore}%
                {showAnimation && (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex items-start gap-2">
                        ...
                        <p
                          className={`text-sm font-medium ${task.completed ? 'line-through text-gray-500 dark:text-gray-400' : ''}`}
                        >
                          {task.title}
                        </p>
                      </div>
          ...
          <div className="text-center py-6">
            ...
            <p className="text-xs text-gray-500 mb-4">
              Add your crops to get personalized recommendations
            </p>
            <Link to="/farm-plan">
