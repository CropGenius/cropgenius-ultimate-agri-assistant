...
export default function GeniusGrow({
  ...
  const generateRecommendation = trackOperation(
    'generateRecommendation',
    async () => {
      setLoading(true);
      try {
        console.log(
          '🧠 [GeniusGrow] Generating fertilizer recommendation for:',
          selectedCrop,
          'on',
          selectedSoilType,
          'soil'
        ...
        logSuccess('recommendation_generated', {
          crop: selectedCrop,
  ...
  const getFertilizerRecommendation = (
    ...
    const baseRecommendations: Record<string, any> = {
      maize: {
        ...
        applicationTiming:
          'Split application: 40% at planting, 60% at knee-high stage',
      ...
      coffee: {
        ...
        applicationTiming:
          'Split into three equal applications throughout the growing season',
    ...
    const amountPerHectare =
      soilAdjusted.amountPerHectare || baseRec.amountPerHectare;
  ...
  return (
    <Card className="border-primary/20 shadow-lg">
      <CardHeader className="bg-primary-50 dark:bg-primary-900/30 pb-3">
        ...
        <CardDescription>
          Get AI-powered fertilizer recommendations tailored to your crops and
          soil
        </CardDescription>
      </CardHeader>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input
                ...
                disabled={loading}
              />
              <Select value={fieldSizeUnit} disabled={true}>
            ...
            <div className="flex items-start justify-between">
              ...
              >
                <Volume2
                  className={cn(
                    'h-4 w-4',
                    speakingRecommendation && 'animate-pulse'
                  )}
                />
