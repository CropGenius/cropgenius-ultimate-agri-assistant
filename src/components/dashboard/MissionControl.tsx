      ...
      setLocalActions([
        {
          ...
          description:
            'Heavy rain forecast. Complete harvest to prevent grain damage.',
          icon: null,
          type: 'harvest',
          urgency: 'critical',
        ...
        },
        {
          ...
          description:
            'Low soil moisture detected in Eastern section. Irrigation recommended.',
          icon: null,
          type: 'water',
          urgency: 'recommended',
          potential_gain: 8400,
        ...
        },
        {
          ...
          description:
            'Market prices rising. Consider selling your harvest this week.',
          icon: null,
          type: 'market',
          urgency: 'optional',
          potential_gain: 5200,
              ...
              .map((action, index) => (
                <Card
                  ...
                  className={cn(
                    ...
                    action.completed
                      ? 'opacity-60 border-l-green-500 bg-muted/30'
                  ...
                  <div className="p-3 flex items-center gap-3">
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        !action.completed &&
                          'hover:bg-green-100 hover:text-green-600 dark:hover:bg-green-900/30'
                      )}
          ...
          <div className="mt-4 space-y-2">
            <div className="bg-muted/50 rounded-lg p-3">
              <div className="flex items-center justify-between text-sm mb-1">
                <span>
                  {completedCount} of {localActions.length} Genius Actions
                  complete
                </span>
                <span className="text-green-600 font-medium">
                  ₦{potentialValue.toLocaleString()} value
                </span>
              </div>
              <div className="h-2 bg-muted rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(completedCount / localActions.length) * 100}%`,
                  }}
                ></div>
              </div>
            </div>
