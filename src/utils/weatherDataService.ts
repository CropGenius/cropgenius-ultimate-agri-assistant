 ...
 */
export const fetchUserWeatherData = async (
  userId: string,
  location: LocationData
): Promise<AppWeatherData | null> => {
  try {
    console.log(
    ...
    toast.error('Failed to fetch weather data', {
      description:
        'There was an error retrieving your weather data. Please try again.',
    });
    return null;
  }
};
