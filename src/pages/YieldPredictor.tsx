...
const [optimizationOptions, setOptimizationOptions] = useState<OptimizationOption[]>([]);
  ...
  const onSubmit = (data) => {
    ...
    setTimeout(() => {
      ...
      toast.success("AI Analysis Complete", {
        description: "We've analyzed your farm data and generated yield predictions",
      });
    }, 2500);
  };
  ...
  const calculateEstimatedYield = (data) => {
    // Mock calculation
    const baseYield = data.cropType === "Maize" ? 7.5 : 
                     data.cropType === "Tomatoes" ? 25 : 
                     data.cropType === "Cassava" ? 15 : 10;
  ...
  const calculateEstimatedRevenue = (data) => {
    ...
    const pricePerUnit = data.cropType === "Maize" ? 0.35 : 
                         data.cropType === "Tomatoes" ? 0.85 : 
                         data.cropType === "Cassava" ? 0.25 : 0.5;
  ...
  const calculateWaterRequirements = (data) => {
    // Mock calculation
    const baseReq = data.cropType === "Maize" ? 500 : 
                   data.cropType === "Tomatoes" ? 700 : 
                   data.cropType === "Cassava" ? 400 : 550;
  ...
  const generateRisks = (data) => {
    ...
    if (data.expectedRainfall === "low") {
      risks.push({
        ...
        probability: "High",
        impact: "Severe",
        mitigation: "Install irrigation system, use drought-resistant varieties"
      });
    }
  ...
  const applyOptimization = (optimizationId) => {
    ...
    const optimization = optimizationOptions.find(opt => opt.id === optimizationId);
    
    if (optimization) {
      // Update prediction data to reflect optimization
      if (predictionData) {
        const yieldIncrease = parseFloat(optimization.yieldIncrease.replace('%', '')) / 100;
        ...
        const updatedPrediction = {
          ...
          appliedOptimizations: [...(predictionData.appliedOptimizations || []), optimization]
        };
          ...
          <div className="space-y-6">
              ...
              <CardContent>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                  <div className="flex justify-between mb-2">
                    <div className="text-sm text-gray-500">Optimal Harvest Date</div>
                  ...
                  <div className="flex justify-between">
                    <div className="text-sm text-gray-500">Water Requirements</div>
                    <div className="flex items-center text-sm font-medium">
            ...
            <Tabs defaultValue="charts" className="w-full">
              ...
              <TabsContent value="charts" className="space-y-4">
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-lg">Yield & Rainfall Correlation</CardTitle>
                    <CardDescription>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <div className="bg-amber-50 p-3 rounded-md mt-4 flex items-start">
                      ...
                      <div>
                        <div className="font-medium text-amber-800">Price Insights</div>
              ...
              <TabsContent value="comparison" className="space-y-4">
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-lg">Regional Yield Comparison</CardTitle>
                    <CardDescription>
                  ...
                  <CardContent>
                    ...
                    <div className="bg-green-50 p-3 rounded-md mt-4 flex items-start">
                      ...
                      <div>
                        <div className="font-medium text-green-800">Your Performance</div>
                        <p className="text-sm text-green-700">
                          Your predicted yield is {predictionData.comparisonToAverage} higher than the regional average. Your soil management and crop selection are working well.
                        </p>
                      </div>
                    </div>
                  </CardContent>
              ...
              <TabsContent value="soil" className="space-y-4">
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-lg">Soil Fertility Analysis</CardTitle>
                    <CardDescription>
                  ...
                  <CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                      <div className="bg-blue-50 p-3 rounded-md flex items-start">
                        ...
                        <div>
                          <div className="font-medium text-blue-800">Soil Health</div>
                          <p className="text-sm text-blue-700">
                            Your soil has good overall health but could benefit from added organic matter to improve structure and water retention.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-blue-50 p-3 rounded-md flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-700">
                            Add compost or manure before your next planting season. Consider crop rotation with legumes to improve nitrogen levels naturally.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    {optimizationOptions.map((optimization) => (
                      <div 
                        ...
                        className={`border p-4 rounded-lg ${
                          optimization.applied ? 'bg-green-50 border-green-200' : 'bg-white'
                        }`}
                      >
                        <div className="flex justify-between items-start">
                          <div>
                        ...
                        <div className="grid grid-cols-3 gap-2 mt-3 text-sm">
                          <div>
                            ...
                            <span className="font-medium">{optimization.costImpact}</span>
                          </div>
                          <div>
                            <span className="text-gray-500">Difficulty: </span>
                            <span className="font-medium">{optimization.implementation}</span>
                          </div>
                          <div>
                            <span className="text-gray-500">Time: </span>
                            <span className="font-medium">{optimization.timeRequired}</span>
                          </div>
                        </div>
                        ...
                        {optimization.applied && (
                          <Button 
                            ...
                            onClick={() => {
                              toast.info("This would open detailed implementation steps");
                            }}
                          >
