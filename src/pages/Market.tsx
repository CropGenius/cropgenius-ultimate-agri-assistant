        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="mb-6">
                      ...
                      {crop.isListed && (
                        <Button 
                          ...
                          onClick={() => {
                            ...
                            if (listing) withdrawListing(listing.id);
                          }}
                        >
                          Remove Listing
                        </Button>
          ...
          <TabsContent value="bulkdeals" className="mt-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600">Join other farmers to sell together and get better prices</p>
              
              {bulkDeals.map(deal => (
                <Card key={deal.id} className={`overflow-hidden ${deal.isNew ? 'border-amber-400' : ''}`}>
                  <CardContent className="p-4">
                    <div className="flex items-start">
                      <div className="flex-grow">
                        <div className="flex items-center mb-1">
                          <h3 className="font-semibold text-lg mr-2">{deal.cropType} Bulk Deal</h3>
                          {deal.isNew && (
                            <Badge className="bg-amber-100 text-amber-800 border-amber-200">
                              New Opportunity
                            </Badge>
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-3">
                          ...
                          <div>
                            ...
                            <p className="font-medium">{deal.minQuantity} kg</p>
                          </div>
                          <div>
                        ...
                        <div className="mb-3">
                          <p className="text-sm text-gray-600">Price Bonus</p>
                          <p className="text-xl font-bold text-crop-green-700">+{deal.priceBonus}% above market</p>
                        </div>
                        
                        <div className="mt-3">
                          <div className="flex justify-between mb-1 text-sm">
                            <span>{deal.farmersJoined} farmers joined</span>
                            <span>{deal.targetFarmers} target</span>
                          </div>
                          <div className="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                            <div 
                              className="h-full bg-crop-green-500 rounded-full" 
                              style={{ width: `${(deal.farmersJoined / deal.targetFarmers) * 100}%` }}
                            ></div>
                          </div>
                          <p className="text-xs text-gray-600 mt-1">
                            {deal.targetFarmers - deal.farmersJoined} more farmers needed to activate this deal
                          </p>
                        </div>
                        
                        <div className="mt-3 bg-blue-50 p-3 rounded-lg border border-blue-100">
                          <p className="flex items-center text-sm font-medium text-blue-800">
                            <ShieldCheck className="h-4 w-4 mr-1 text-blue-600" />
                            Buyer Information:
                          </p>
                          <p className="text-xs text-blue-700 mt-1">
                            {deal.buyer} - Verified buyer with secure payment
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <TabsContent value="buyers" className="mt-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600">Premium buyers looking to purchase your crops</p>
                      ...
                      <div className="flex-grow">
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-3">
                          ...
                          <div>
                            ...
                            <p className="font-medium capitalize">{buyer.dealSize}</p>
                          </div>
                          <div>
                            <p className="text-sm text-gray-600">Payment Methods</p>
                            <p className="font-medium">{buyer.paymentMethods.join(", ")}</p>
                          </div>
                          <div>
                        ...
                        <div className="mb-3">
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            {buyer.lookingFor.map((crop, index) => (
                        ...
                        <div className="flex items-center text-sm text-gray-600 mb-3">
                          ...
                          <span className="font-medium">{buyer.rating}/5.0 Rating</span>
                          <span className="mx-2">•</span>
                          <DollarSign className="h-4 w-4 text-crop-green-500 mr-1" />
                          <span className="font-medium">Pays {buyer.offersAboveMarket}% above market</span>
                          <span className="mx-2">•</span>
                          <Clock className="h-4 w-4 text-sky-blue-500 mr-1" />
                          <span className="font-medium">{buyer.paysFast ? 'Fast payment' : 'Standard payment'}</span>
                        </div>
                        ...
                        <div className="bg-amber-50 p-3 rounded-lg border border-amber-100">
                          ...
                          <p className="text-xs text-amber-700 mt-1">
                            This buyer pays {buyer.offersAboveMarket}% above market rates for quality produce
                          </p>
                        </div>
                      </div>
                    </div>
