  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: 'assistant',
      content:
        "Hello! I'm your AI farming assistant. I can help with crop diseases, weather analysis, growing techniques, market information, and more. What would you like to know about farming today?",
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const fallbackMessage: Message = {
        ...
        role: 'assistant',
        content:
          "I'm sorry, I encountered an issue while processing your question. Please try again or ask something different.",
        timestamp: new Date(),
      };
          ...
          <div className="md:col-span-9">
            <Card className="h-[75vh] flex flex-col">
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  Ask any farming question to get expert advice and
                  recommendations
                </CardDescription>
              </CardHeader>
