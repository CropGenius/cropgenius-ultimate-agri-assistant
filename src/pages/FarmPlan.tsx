...
const FarmPlan = () => {
  ...
  const [tasks, setTasks] = useState<Task[]>([
    ...
    },
    {
      ...
      aiRecommended: true,
      conditions: [
        'Pest Detection: Aphids',
        'Affected Area: Northeast Field',
    ...
    },
    {
      ...
      conditions: [
        'Crop Maturity: 95%',
        'Market Price Trend: Rising',
        'Weather: Clear until Saturday',
      ],
    },
    {
      id: 4,
      ...
      conditions: [
        ...
        'Recent Rain: pH may have changed',
      ],
    },
  ]);
  ...
  const [weatherAlerts, setWeatherAlerts] = useState<WeatherAlert[]>([
    {
      ...
      description:
        '90% chance of heavy rainfall in your area in the next 48 hours. Consider delaying any fertilizer application.',
      impact: 'high',
      icon: CloudRain,
      isNew: true,
    },
    {
      ...
      description:
        'Temperatures expected to reach 38°C by next week. Prepare additional irrigation for tomato crops.',
      impact: 'medium',
      icon: Sun,
      isNew: false,
    },
  ...
  const refreshPlan = () => {
    ...
    setTimeout(() => {
      toast.success('Farm plan updated with latest AI analysis', {
        description:
          'Analyzing soil conditions, weather patterns, and crop health',
      });
      ...
      const newTask: Task = {
        ...
        aiRecommended: true,
        conditions: [
          'Calcium Deficiency Detected',
          'Weather: Suitable for application',
        ],
        isNew: true,
      };
      ...
      <div className="p-5 pb-20 animate-fade-in">
        ...
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <p className="text-gray-600">
              Personalized for {farmer.name}'s {farmer.farmSize} acre farm
            </p>
          </div>
          <Button
            onClick={refreshPlan}
        ...
        <Card className="mb-5 border-crop-green-200 bg-crop-green-50">
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              AI-optimized for your specific crops and conditions
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-3 mb-2">
              <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-100">
                ...
                <p className="text-xl font-bold text-crop-green-700">
                  {planOverview.weeklyTasks}
                </p>
              </div>
              <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-100">
                <p className="text-xs text-gray-500">Completed</p>
                <p className="text-xl font-bold text-crop-green-700">
                  {planOverview.completedTasks}/{planOverview.weeklyTasks}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center bg-amber-50 p-2 rounded-md border border-amber-100">
              ...
              <span className="text-sm text-amber-700">
                {planOverview.highPriorityTasks} high-priority tasks need your
                attention
              </span>
            </div>
          </CardContent>
              ...
              <CardContent className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="flex-grow">
                    ...
                    <h3
                      className={`font-medium mt-1 ${task.completed ? 'text-gray-400 line-through' : 'text-gray-800'}`}
                    >
                      {task.text}
                    </h3>
