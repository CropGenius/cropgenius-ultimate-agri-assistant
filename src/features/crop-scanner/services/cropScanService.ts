...
export const analyzeCropImage = async (
  ...
  try {
    ...
    return {
      ...
      treatmentProducts: [
        {
          name: 'Agro-Copper Fungicide',
          price: '1,200 KES',
          effectiveness: 92,
          availability: 'Available at Kilimo Stores (2.3km away)',
        },
        {
          name: 'Organic Neem Extract',
          price: '850 KES',
          effectiveness: 76,
          availability: 'Available at Green Farmer Market (4.1km away)',
        },
        {
          name: 'Bio-Protection Spray',
          price: '1,450 KES',
          effectiveness: 88,
          availability: 'Available online - delivery in 2 days',
        },
      ],
