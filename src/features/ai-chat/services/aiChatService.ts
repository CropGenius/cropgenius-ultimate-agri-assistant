...
export const fetchAIResponse = async (
  ...
  try {
    console.log(
      `Sending message to AI in category: ${category}, language: ${language}`
    );
    ...
    const fallbackResponses = {
      ...
      crops:
        'For optimal crop management in your climate zone, I recommend spacing maize plants 75cm between rows and 30cm within rows. Apply nitrogen fertilizer as a top dressing when plants reach knee height for maximum yield.',
      diseases:
        "The symptoms you've described match Tomato Late Blight (Phytophthora infestans). This fungal disease spreads rapidly in humid conditions. Apply copper-based fungicide immediately and ensure better airflow between plants.",
      machinery:
        'For a farm your size, a walking tractor (two-wheel tractor) would be more cost-effective than a full tractor. Look for multipurpose models that can be fitted with different implements for plowing, harrowing, and transportation.',
      market:
        'Current market data shows maize prices trending upward by 15% over the next month due to regional shortages. Consider holding your harvest for 3-4 weeks if storage conditions permit for potentially higher returns.',
    };
